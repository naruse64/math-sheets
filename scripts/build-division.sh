...
# 
# 使用例:
#   ./build-division.sh 1                    # +1 標準版（問題のみ）
#   ./build-division.sh 1 --answer           # +1 標準版（問題+解答）
#   ./build-division.sh 1 --border           # +1 標準版+枠あり版（問題のみ）
#   ./build-division.sh 1 --2up              # +1 標準版+2up版（問題のみ）
#   ./build-division.sh 1 --all              # +1 全バリエーション
#   ./build-division.sh 1 --answer --border --2up  # 複数組み合わせ
